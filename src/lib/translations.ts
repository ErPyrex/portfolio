...
export const esTranslations: TranslationSchema = {
  ...
  hero_paragraph:
    "Especializado en Next.js, Expo (React Native), Linux, Docker, Bash, PostgreSQL y Supabase. Integro flujos CI/CD con GitHub Workflows e impulso el ciclo de desarrollo con asistentes de IA. Despliego en Vercel y Render.",
  hero_badge_title: "Perfil de Ingeniería & Sysadmin",
  hero_badge_desc:
    "Linux nativo, scripting en Bash, contenedorización en Docker, consultas SQL (PostgreSQL/SQLite) y desarrollo Web/Móvil con Next.js y Expo.",
  ...
  projects_desc:
    "Proyectos reales desplegados en producción donde aplico desarrollo Web/Móvil, optimización de rendimiento e infraestructura cloud.",
  ...
  projects_nutri_focus_desc:
    "Herramienta web interactiva enfocada en el cálculo instantáneo de métricas nutricionales, macros y necesidades calóricas con una interfaz reactiva de alta velocidad.",
  projects_nutri_perf_title: "Despliegue & Rendimiento:",
  projects_nutri_perf_desc:
    "Desplegado en Vercel con renderizado instantáneo y respuesta inmediata al cálculo del usuario.",
  projects_nutri_tech_title: "02. Solución Técnica",
  projects_nutri_tech_item1:
    "Desarrollado sobre arquitectura SSR/CSR ligera en Next.js.",
  projects_nutri_tech_item2:
    "Lógica matemática optimizada en cliente para cálculos en tiempo real.",
  projects_nutri_tech_item3:
    "Diseño responsivo fluido adaptable a móviles y escritorio.",
  ...
  projects_nutri_details_long:
    "Plataforma web de cálculo nutricional desarrollada con Next.js y desplegada en Vercel. Cuenta con renderizado en el borde e interfaz reactiva para cómputo inmediato en el cliente.",

  projects_dorologi_tag: "E-Commerce Platform",
  projects_dorologi_focus_title: "01. Enfoque Comercial",
  projects_dorologi_focus_desc:
    "Tienda en línea completa orientada a la exhibición de catálogo, conversión de ventas, navegación fluida de productos y experiencia de compra optimizada.",
  projects_dorologi_perf_title: "Resultado E-Commerce:",
  projects_dorologi_perf_desc:
    "Diseño web limpio, rápida carga de imágenes de catálogo y estructuración optimizada para comercio.",
  projects_dorologi_tech_title: "02. Solución Técnica",
  projects_dorologi_tech_item1:
    "Arquitectura web orientada a catálogo interactivo y velocidad.",
  projects_dorologi_tech_item2:
    "Diseño e interfaz de usuario estilizada con adaptación mobile-first.",
  projects_dorologi_tech_item3:
    "Integración de dominio personalizado y configuración de producción.",
  ...
  projects_dorologi_details_long:
    "Plataforma e-commerce completa para Dorologi Store con diseño adaptativo, pasarela estructurada y catálogo interactivo fluido.",
  ...
  contact_desc:
    "Estoy listo para sumarme a proyectos o vacantes de desarrollo. Envíame un mensaje directo o copia mi correo de contacto.",
  contact_info_title: "Información de Contacto",
  contact_info_desc:
    "No dudes en contactarme directamente vía email o a través de este formulario. Respondo habitualmente en menos de 24 horas.",
  ...
  footer_copy:
    "© 2026 Sergio Rodriguez (Pyrex64) — Ingeniero en Informática. Linux, Docker & Desarrollo Web/Móvil.",

  modal_booking_title: "Agendar Entrevista",
  modal_booking_subtitle:
    "Conecta directamente con Sergio Rodriguez (Pyrex64).",
  ...
  modal_case_guarantee_item1:
    "✓ Ambientes probados en Linux OS local y servidores remotos",
  modal_case_guarantee_item2: "✓ Automatización mediante scripts Bash y Docker",
  modal_case_guarantee_item3:
    "✓ Persistencia de datos limpia en PostgreSQL / SQLite",
  modal_case_close: "Cerrar",

  lang_disclaimer:
    "Nota: Poseo nivel de inglés técnico adecuado para comprender requerimientos y documentación.",

  terminal_welcome:
    "Terminal Interactiva de Sergio Rodriguez (Pyrex64). Escribe 'help' para comandos.",
...
export const enTranslations: TranslationSchema = {
  ...
  hero_heading_gradient_orange: "Linux & Docker",
  hero_paragraph:
    "Specialized in Next.js, Expo (React Native), Linux, Docker, Bash, PostgreSQL, and Supabase. I integrate CI/CD pipelines via GitHub Workflows and accelerate cycles using AI-driven development. I deploy on Vercel and Render.",
  hero_badge_title: "Engineering & Sysadmin Profile",
  hero_badge_desc:
    "Native Linux, Bash scripting, containerization with Docker, SQL queries (PostgreSQL/SQLite), and Web/Mobile development with Next.js and Expo.",
  ...
  projects_desc:
    "Real-world projects deployed in production, applying Web/Mobile development, performance optimization, and cloud infrastructure.",
  ...
  projects_nutri_focus_desc:
    "An interactive web tool focused on instant calculation of nutritional metrics, macros, and caloric needs with a high-speed reactive interface.",
  projects_nutri_perf_title: "Deployment & Performance:",
  projects_nutri_perf_desc:
    "Deployed on Vercel with instant rendering and immediate response to user inputs.",
  projects_nutri_tech_title: "02. Technical Solution",
  projects_nutri_tech_item1:
    "Developed on a lightweight SSR/CSR architecture in Next.js.",
  projects_nutri_tech_item2:
    "Client-side optimized mathematical logic for real-time calculations.",
  projects_nutri_tech_item3:
    "Fluid responsive design adaptable to mobile and desktop.",
  ...
  projects_nutri_details_long:
    "A web platform for nutritional calculation developed with Next.js and deployed on Vercel. Features edge rendering and a reactive interface for immediate client-side computation.",

  projects_dorologi_tag: "E-Commerce Platform",
  projects_dorologi_focus_title: "01. Commercial Focus",
  projects_dorologi_focus_desc:
    "Complete online store oriented towards catalog display, sales conversion, smooth product navigation, and optimized buying experience.",
  projects_dorologi_perf_title: "E-Commerce Outcome:",
  projects_dorologi_perf_desc:
    "Clean web design, fast loading catalog images, and optimized structures for commerce.",
  projects_dorologi_tech_title: "02. Technical Solution",
  projects_dorologi_tech_item1:
    "Web architecture designed for interactive catalog speed and checkout flow.",
  projects_dorologi_tech_item2:
    "Stylized UI layout using a mobile-first approach.",
  projects_dorologi_tech_item3:
    "Custom domain integration and production environments config.",
  ...
  projects_dorologi_details_long:
    "A comprehensive e-commerce platform for Dorologi Store, built with responsive layout, customized checkout steps, and fluid interactive catalog.",
  ...
  contact_desc:
    "I am ready to join projects or development vacancies. Send me a direct message or copy my contact email.",
  contact_info_title: "Contact Information",
  contact_info_desc:
    "Feel free to reach out directly via email or through this form. I usually respond in less than 24 hours.",
  ...
  contact_success_desc:
    "Thank you for getting in touch. I will respond to you shortly.",

  footer_copy:
    "© 2026 Sergio Rodriguez (Pyrex64) — Computer Engineer. Linux, Docker & Web/Mobile Development.",
  ...
  modal_case_guarantee_item1:
    "✓ Environments verified on local Linux OS & remote servers",
  ...
  lang_disclaimer:
    "Note: I possess technical English proficiency sufficient for understanding requirements and docs.",

  terminal_welcome:
    "Sergio Rodriguez (Pyrex64) Interactive Terminal. Type 'help' for commands.",
