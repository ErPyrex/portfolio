        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="mt-6 space-y-6 text-zinc-400">
              <p>
                Hello! I&apos;m Alex, a software engineer who loves crafting
                interactive, high-performance digital solutions. My journey in
                web development began over 5 years ago, and since then, I have
                worked with startups and established companies to turn ideas
                into robust applications.
              </p>
              <p>
                I thrive at the intersection of design and engineering—writing
                clean, maintainable code while keeping a keen eye on user
                experience, performance, and accessibility (a11y).
              </p>
              <p>
                When I&apos;m not coding, you can find me exploring open-source
                projects, playing chess, or writing technical articles about
