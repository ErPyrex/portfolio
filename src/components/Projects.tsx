...
export default function Projects({ t, lang, openCaseStudy }: ProjectsProps) {
  ...
  return (
    <section
      id="projects"
      className="relative z-10 py-16 px-4 max-w-5xl mx-auto"
    >
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pb-6 border-b border-zinc-900/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 font-mono">
                E-Commerce Platform • Web Development • Fast UI/UX
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="font-mono text-xs text-zinc-400 space-y-1 mt-3">
              <div className="text-orange-400 font-bold flex items-center gap-1.5">
                <Cpu className="h-3.5 w-3.5 animate-pulse" aria-hidden="true" />
                <span>
                  {t.projects_dorologi_perf_title}() {"{"}
                </span>
              </div>
              <p className="pl-4 border-l border-zinc-900 text-zinc-300 py-1 leading-relaxed">
            ...
            <div className="pt-4 flex items-center justify-between gap-2">
              ...
              <button
                ...
                onClick={() =>
                  openCaseStudy(
                    "Dorologi Store",
                    t.projects_dorologi_details_long,
                  )
                }
                className="text-xs font-medium text-zinc-400 hover:text-white flex items-center gap-1.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/40 rounded-lg p-1"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span
                    className={`px-2.5 py-0.5 rounded-lg text-[10px] font-mono font-bold bg-zinc-900/40 ${repo.tagColor}`}
                  >
                    {repo.tag}
                  </span>
                  <Code
          ...
          >
            ...
            <p className="text-[11px] text-zinc-500 mt-1">
              {lang === "es"
                ? "Explora todos mis repositorios y dotfiles."
                : "Explore all my active repos and dotfiles configs."}
            </p>
          </a>
        </div>
      </div>
